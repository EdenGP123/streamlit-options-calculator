...
# Gain/Loss at given expiration price
expiration_price = st.number_input('Enter Expiration Price', value=100.0)
if st.button('Calculate Gain/Loss at Expiration'):
    gain_loss = calculate_pnl(expiration_price, legs)
    st.write(f'Gain/Loss at Expiration Price {expiration_price}: {gain_loss * contract_size:.2f}')
